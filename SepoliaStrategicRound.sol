...
contract SepoliaStrategicRound {
    ...
    uint256 public tokenPrice = 4e3;
    uint256 public SaleBalance = 50e24;
    uint256 public MINIMUM_PURCHASE = 10e6;
    uint256 public MAXIMUM_PURCHASE = 2e10;
    ...
    function buyToken(uint256 usdtAmount) external {
        ...
        uint256 reservedAmount = (usdtAmount * 1e6) / tokenPrice;
